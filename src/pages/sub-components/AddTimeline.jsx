...
useEffect(()=>{
  if(error){
    toast.error(clearAllTimelineErrors());
  }
  if(message){
          ...
          <form className='w-[100%] px-5 md:w-[650px]' onSubmit={handleAddNewTimeline}>
            <div className='space-y-12'>
                <div className='border-b border-gray-900/10 pb-12'>
                    <h2 className='font-semibold leading-7 text-gray-900 text-3xl text-center'>ADD A NEW TIMELINE
                    </h2>
                    <div className='mt-10 flex flex-col gap-5'>
                       ...
                       <div className='w-full sm:col-span-4'>
                         ...
                         <div className='mt-2'>
                              <div className='flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2focus-within:ring-inset focus-within:ring-indigo-600'>
                               <Textarea type="text" placeholder='Timeline Description' value={description} onChange={(e)=>setDescription(e.target.value)}
                               className='block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6'
                               />
                              </div>
                         </div>
                       ...
                       <div className='w-full sm:col-span-4'>
                         ...
                         <div className='mt-2'>
                              <div className='flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2focus-within:ring-inset focus-within:ring-indigo-600'>
                               <input type="number" placeholder='Ending Period' value={to} onChange={(e)=>setTo(e.target.value)}
                               className='block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6'
                               />
                              </div>
                         </div>
                ...
                </div>
                {
                  ...
                  type="submit" className="w-full">Add Timeline</Button>
                }
            </div>
          </form>
       </div> 
