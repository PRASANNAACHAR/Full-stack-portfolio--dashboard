        ...
        <form className='w-[100%] px-5 md:w-[650px]' onSubmit={handleAddNewApplication}>
          <div className='space-y-12'>
            <div className='border-b border-gray-900/10 pb-12'>
              <h2 className='font-semibold leading-7 text-gray-900 text-3xl text-center'>ADD A NEW APPLICATION
              </h2>
                ...
                <div className='w-full sm:col-span-4'>
                  ...
                  <div className='mt-2'>
                    <div className='flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2focus-within:ring-inset focus-within:ring-indigo-600'>
                      <input type="text" placeholder='Applications' value={name} onChange={(e) => setName(e.target.value)}
            ...
            </div>
            {
              loading ? <SpecialLoadingButton content={"Adding..."} /> : <Button
                type="submit" className="w-full">Add Applications</Button>
            }
          </div>
        </form>
      </div>
