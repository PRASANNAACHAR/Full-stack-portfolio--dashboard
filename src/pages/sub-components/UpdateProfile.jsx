...
const UpdateProfile = () => {
  ...
  const [phone,setPhone] = useState(user && user.email);
            ...
            <div className='grid gap-6'>
                <div className='flex items-start lg:justify-between lg:items-center flex-col lg:flex-row gap-5'>
                    ...
                    <div className='grid gap-2 w-full sm:w-72'>
                       ...
                       target='_blank'>
                       <img src={resumePreview ?resumePreview : "./upload_area.png"} alt="resume" className='w-full h-auto sm:w-72 sm:h-72 rounded-2xl' />
                       </Link>
                       <div className='relative'>
                       <input
                        type="file" className='avatar-update-btn' onChange={resumeHandler} />
                       </div>
                    </div>
                </div>
                <div className='grid gap-2'>
