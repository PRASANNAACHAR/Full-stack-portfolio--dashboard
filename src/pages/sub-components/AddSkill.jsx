import { addNewSkill, ClearAllSkillSliceErrors, getAllSkills, resetSkillSlice } from '@/store/slices/SkillSlice.js';
        ...
        <form className='w-[100%] px-5 md:w-[650px]' onSubmit={handleAddNewSkill}>
          <div className='space-y-12'>
            <div className='border-b border-gray-900/10 pb-12'>
              <h2 className='font-semibold leading-7 text-gray-900 text-3xl text-center'>ADD A NEW SKILL
              </h2>
              <div className='mt-10 flex flex-col gap-5'>
                ...
                <div className='w-full sm:col-span-4'>
                  ...
                  <div className='mt-2'>
                    <div className='flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2focus-within:ring-inset focus-within:ring-indigo-600'>
                      <input type="number" placeholder='30' value={proficiency} onChange={(e) => setProficiency(e.target.value)}
                        className='block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6'
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div className="text-center">
                     {svgPreview ? (
                      ...
                      viewBox = "0 0 24 24"
                      src={svgPreview ? `${svgPreview}` : "/upload_area.png"} alt="" />
                     ) : ( 
            ...
            {
              loading ? <SpecialLoadingButton content={"Adding..."} /> : <Button
                type="submit" className="w-full">Add Skill</Button>
            }
          </div>
        </form>
      </div>
