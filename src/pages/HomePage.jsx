...
import { Code, FolderGit, History, Home, LayoutGrid, LogOut, MessageSquareMore, Package, Package2, PanelLeft, PencilRuler, User } from 'lucide-react';
...
const HomePage = () => {
  ...
  return (
    ...
    <div className='flex min-h-screen w-full flex-col bg-muted/40'>
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                 ...
                 transistion-colors hover:text-foreground md:h-8 md:w-8`}
      ...
      <header className='sticky top-0 z-30 flex items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]'>
        <Sheet>
          <SheetTrigger asChild>
             <Button size="icon" variant="outline" className="sm:hidden">
                <PanelLeft className='h-3 w-5'/>
                <span className='sr-only'>Toggle Menu</span>
             </Button>
          </SheetTrigger>
          <SheetContent aside="left" className="sm:max-w-xs">
